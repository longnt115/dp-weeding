...
export default function Events() {
  ...
  return (
    <section
      id="events"
      className="py-10 sm:py-16 md:py-20 bg-wedding-white px-4 sm:px-6"
    >
      <Container>
        <motion.div
        ...
        >
          ...
          <div className="w-12 sm:w-16 h-1 bg-gradient-to-r from-wedding-gold to-wedding-gold-light mx-auto mb-3 sm:mb-4" />
          <p className="text-base sm:text-lg text-wedding-text-secondary max-w-2xl mx-auto px-4">
          ...
          {events.map((event, index) => (
            ...
            >
              ...
              <div className="flex gap-3 sm:gap-4 md:gap-6">
                ...
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-wedding-gold to-wedding-gold-light flex items-center justify-center text-wedding-dark text-base sm:text-lg font-bold shadow-md">
                    {index + 1}
                  </div>
                </motion.div>
