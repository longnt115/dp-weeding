...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-linear-to-br from-wedding-light to-[#e8e8e8] relative overflow-hidden px-4 sm:px-6 lg:px-8"
    >
      ...
      <Container className="text-center relative z-10 w-full">
        ...
        >
          <div className="aspect-[4/3] sm:aspect-video bg-linear-to-br from-wedding-gold via-[#c9a961] to-[#8b7d3f] flex items-center justify-center relative">
            {/* Overlay */}
              ...
              >
                {guest && (
                  <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light">
                    <div className="uppercase pb-3 sm:pb-4 md:pb-6 barlow-thin text-sm sm:text-base md:text-xl">
                      Thư mời tiệc cưới
                    </div>
                    <h2 className="border-solid border-t-2 py-4 sm:py-5 md:py-7 barlow-thin text-base sm:text-lg md:text-xl">
                      Trân Trọng Kính Mời:
                    </h2>
                    <div className="alex-brush-regular border-dotted border-b-1 text-2xl sm:text-3xl md:text-4xl lg:text-5xl py-2 sm:py-3">
                      {guest}
                    </div>
                  </div>
                )}
